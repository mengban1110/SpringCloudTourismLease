...
public class FkEmailUtils {
    ...
    public void sendVerifyEmail(String toEmail, String email, String code) throws MessagingException {
        ...
        helper.setFrom("17633088040@163.com");
     ...
     * @throws MessagingException
     */
    public void sendCheckEmail(String toEmail) throws MessagingException {
        MimeMessage mimeMessage = javaMailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, true);
        helper.setSubject("维修部门管理系统-消息通知");
        helper.setFrom("17633088040@163.com");
        helper.setTo(toEmail);
        helper.setSentDate(new Date());
        helper.setText(getPostEmailContext2(), true);
        javaMailSender.send(mimeMessage);
    }
     ...
     * @return
     */
    private static String getPostEmailContext2() {
        HashMap<String, Object> root = new HashMap<>(2);
        return getEmailHtml(root, "check.ftl");
    }
...
//            String ftl = "C:\\Users\\LuHoYn\\Desktop\\SpringCloudTourismLease-main\\TourismLease-LoginService-8012\\src\\main\\resources\\templates";
            String ftl = "E:\\ProgramCode\\IDEA_Code\\LearnWorkingSet\\D20210608_Cloud\\SpringCloudTourismLease\\TourismLease-Kafka-8888\\src\\main\\resources\\templates";
